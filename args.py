...
def add_common_args(parser):
    ...
    parser.add_argument("--nb_layers", type=int, default=9, help="Encoder layers")
    parser.add_argument("--nb_heads", type=int, default=8, help="Number of heads")
    parser.add_argument("--latent_seq_len", type=int, default=64, help="Latent array seq len")
    parser.add_argument("--latent_emb_size", type=int, default=48, help="Latent array emb size")
